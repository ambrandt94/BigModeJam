...
namespace DestroyIt
{
    public class Bullet : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (hitIndex > -1)
            {
                ProcessBulletHit(hits[hitIndex], transform.forward, ConstantDamage);
                hitSomething = true;
                return;
            }
        ...
        private static void ProcessBulletHit(RaycastHit hitInfo, Vector3 bulletDirection, float constantDamage = 0)
        {
            ...
            foreach (Destructible destObj in destObjs)
            {
                ...
                if (constantDamage > 0) {
                    bulletDamage.DamageAmount = constantDamage;
                    bulletDamage.AdditionalForce = constantDamage;
                }
