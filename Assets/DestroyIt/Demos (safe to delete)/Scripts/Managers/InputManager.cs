...
namespace DestroyIt
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        private Transform fireballTransform;             // The transform where the gun will be fired from.
            ...
            foreach (Transform trans in Camera.main.transform)
            {
                switch (trans.name)
                {
                    ...
                    case "WeaponPosition-Gun":
                        gunTransform = trans;
                        break;
                    case "WeaponPosition-Fireball":
                        fireballTransform = trans;
                        break;
        ...
        {
            WeaponHelper.Launch(fireballPrefab, fireballTransform, 0f, false); // Launch bullet
